...
<html>
<head>
<title>Sowing a Agriculture</title>
...
<div class="banner" id="banner">
		<div class="top-nav w3-agiletop">
			<div class="container">
				<div class="navbar-header w3llogo">
					...
					<h1><a href="index.html">Sowing</a></h1> 
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<div class="w3menu navbar-right">
						<ul class="nav navbar">
							...
							<li><a href="login.php" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">logout</a></li>
						</ul>
					</div> 
		...
		<div class="logo">
					<h2>AGRICULTURE</h2>
					<p>Producing More. Conserving More. Improving Lives.</p>
				</div>
				<div class="container">
					<ul class="rslides" id="slider3">
						<li>
							<div class="slider-info">
								...
								<h3><a href ="cropselec.php">Agriculture</a></h3>
								</div>
								</div>
...
<div class="about" id="about">
		<div class="container">
			...
			<div class="col-md-6 w3_abl">
				...
				<p>We are in this field to help farmers to find the suitable crop for their fields based on soil condirion in their locality and weather conditions.</p>
			</div>
			<div class="col-md-6 w3_abl">
				<h4>What We Do</h4>
				<h5>Agriculture is our Pashion.</h5>
				<p>We will find u the best suitable crop which has the fine porductivity for this particular seasons.</p>
			</div>
		</div>
	</div>
</div>
...
<h4>Sep10, 2018</h4>
<h4>Agriculture was the first big step toward a civilized life.</h4>
<p>Click the below link to know more about agriculture now in India.</p>
<p><h3><a href= "https://timesofindia.indiatimes.com/business/agriculture"> CLICK HERE.</a></h3></p>
</div>
...
<div class="testimonials" id="testimonials">
	<div class="container">
		<h3 class="heading-agileinfo">Happy Clients</h3>
		<div class="flex-slider">
			<ul id="flexiselDemo1">			
				<li>
					<div class="laptop">
					<div class="col-md-8 col-sm-8 team-right">
							<p>This site is popular among various agriculturalist, it is very informative.
							Thank you</p>
							<div class="name-w3ls">
								<h5>Thompson</h5>
							</div>
				...
				<li>
					...
					<div class="col-md-4 col-sm-4 team-left">
						...
						<div class="col-md-8 col-sm-8 team-right">
							<p>This is one of the best site for knowing more information about agriculture and its fields.</p>
							<div class="name-w3ls">
								<h5>Narayen</h5>								
							</div>
						</div>						
		...
		<h3>CONTACT US</h3>
			<div class="footer-grids">
				<div class="col-md-3 col-sm-6 my-info">
					<h4>About </h4>
					<p>Click to know more about our website and more info</p>
					<a href="#">Read more</a>
					<div class="clearfix"></div>
				</div>
...
<p><a class=" scroll" href="#menu"><span class="fa fa-angle-right" aria-hidden="true"></span>Harvest Aids</a></p>
				...
				<div class="col-md-3 col-sm-6 iteams">
					...
					<ul class="agile_footer_grid_list">
						<li>351, Nehru Street,<br>Ram nagar,<br>Gandhipuram<br>Coimbatore - 641009.</li>
						<li><span class="fa fa-phone"></span> +91 9595756689</li>
						<li><span class="fa fa-envelope-o"></span><a href="mailto:info@example.com">nana2232@gmail.com</a></li>
					</ul>
				</div>
				<div class="clearfix"></div>
			</div>
